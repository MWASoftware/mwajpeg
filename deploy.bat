...
"%WIX%\light" -out release\full\mwajpeg.msi install.wixobj examples.wixobj delphi6.wixobj delphi2007.wixobj source.wixobj %WIX%\WixUI.wixlib -loc %WIX%\WixUI_en-us.wxl
IF ERRORLEVEL 1 goto QUIT
