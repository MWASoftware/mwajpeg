...
"%D6%\bin\dcc32" mwajpg.dpk /DDESIGNTIME;NODLL;%DEFS% /$D-,L-,Y-,R- /B /Z- /OObj /NUnits\D6 
IF ERRORLEVEL 1 goto Quit
move dclmwajpgD6.bpl Packages
del mwajpg.dcp

"%D6%\bin\dcc32" mwajpg.dpk /DNODLL;%DEFS% /$D-,L-,Y-,R- /M /Z- /OObj /UUnits\D6 /NUnits\D6
IF ERRORLEVEL 1 goto Quit
...
"%D7%\bin\dcc32" mwajpg.dpk /DDESIGNTIME;NODLL;%DEFS% /$D-,L-,Y-,R- /B /Z- /OObj /NUnits\D7 /LEPackages 
IF ERRORLEVEL 1 goto Quit
"%D7%\bin\dcc32" mwajpg.dpk /DNODLL;%DEFS% /$D-,L-,Y-,R- /M /Z- /OObj /UUnits\D7 /NUnits\D7 /LEPackages /LNPackages\D7
IF ERRORLEVEL 1 goto Quit
...
"%CB5%\bin\make" -B PDEFS=DESIGNTIME;CBUILDER5;%DEFS% DLLSTATE=NODLL -f mwajpg.mak -DB5 -DUNITDIR=Units\cb5
IF ERRORLEVEL 1 goto QUIT1
move mwajpg.bpl Packages\dclmwajpgcb5.bpl
del mwajpg.bpi
"%CB5%\bin\make" -B PDEFS=CBUILDER5;%DEFS% DLLSTATE=NODLL -f mwajpg.mak -DB5 -DUNITDIR=Units\cb5 -DRUNTIME
IF ERRORLEVEL 1 goto QUIT1
...
IF ERRORLEVEL 1 goto Quit
rename source\jpeglib.pas _jpeglib.pas
"%CB6%\bin\make" -B PDEFS=DESIGNTIME;CBUILDER5;%DEFS% DLLSTATE=NODLL -f mwajpg.mak -DB6 -DUNITDIR=Units\cb6
IF ERRORLEVEL 1 goto QUIT1
move mwajpg.bpl Packages\dclmwajpgcb6.bpl
del mwajpg.bpi
"%CB6%\bin\make" -B PDEFS=CBUILDER5;%DEFS% DLLSTATE=NODLL -f mwajpg.mak -DB6 -DUNITDIR=Units\cb6 -DRUNTIME
IF ERRORLEVEL 1 goto QUIT1
rename source\_jpeglib.pas jpeglib.pas
del jpeg_reg.obj mwajpg.obj mwajpg.dcu mwajpg.tds mwajpg.lib
